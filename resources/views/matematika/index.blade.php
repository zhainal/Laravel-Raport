...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/matematika/index.css') }}">
@endsection

@section('content')
    <section class="section-ppkn">
      <div class="sidebar">
        <h1 class="heading-primary heading">Matematika</h1>
      ...
      <div class="main">
        <div class="button">
          ...
          <div class="modal">
            ...
            <form action="{{ route('matematika.import') }}" method="post" enctype="multipart/form-data" class="form-modal">
              @csrf
              <input type="file" class="input-file" name="nilai_matematika" id="nilai_matematika">
        ...
        <div class="content">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td scope="row">
                  <a href="{{ route('matematika.show', $p->id) }}" class="btn-edit">Lihat</a>
                  ...
                  <div class="confirm">
                    ...
                    <div class="main-confirm">
                      ...
                      <div class="btn-confirm">
                        ...
                        <form action="{{ route('matematika.destroy', $p->id) }}" method="post">
                          @csrf
                          @method('DELETE')
          ...
          @else
          <div class="empty">
            <p class="desc-dark">Belum Ada Data Nilai Matematika Siswa</p>
          </div>
          @endif
        </div>
      </div>
