...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/IPA/index.css') }}">
@endsection
      ...
      <div class="main">
        <div class="button">
          ...
          <div class="modal">
            ...
            <form action="{{ route('IPA.import') }}" method="post" enctype="multipart/form-data" class="form-modal">
              @csrf
              <input type="file" class="input-file" name="nilai_IPA" id="nilai_IPA">
        ...
        <div class="content">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td scope="row">
                  <a href="{{ route('IPA.show', $p->id) }}" class="btn-edit">Lihat</a>
                  ...
                  <div class="confirm">
                    ...
                    <div class="main-confirm">
                      ...
                      <div class="btn-confirm">
                        ...
                        <form action="{{ route('IPA.destroy', $p->id) }}" method="post">
                          @csrf
                          @method('DELETE')
          ...
          @else
          <div class="empty">
            <p class="desc-dark">Belum Ada Data Nilai IPA Siswa</p>
          </div>
          @endif
        </div>
      </div>
