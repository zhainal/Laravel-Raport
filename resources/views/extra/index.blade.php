...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/extra/index.css') }}">
@endsection
...
@section('content')
    <section class="section-extra">
      ...
      <div class="main">
        <div class="button">
          <a href="#" class="btn-add" id="btn-add">Masukkan Data Lainnya</a>

          <div class="modal">
            <h1 class="heading-primary">Import Data</h1>
            <form action="{{ route('extra.import') }}" method="post" enctype="multipart/form-data" class="form-modal">
              @csrf
              <input type="file" class="input-file" name="extra" id="extra">
        ...
        @if (session('error'))
        <div class="alert alert-danger" role="alert">
          {{session('error')}} Pastikan anda menulis data lain siswa pada format yang telah diberikan.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="content">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td scope="row">{{ $p->saran }}</td>
                <td scope="row">
                  <a href="{{ route('extra.edit', $p->id) }}" class="btn-edit">Edit</a>
                  ...
                  <div class="confirm">
                    ...
                    <div class="main-confirm">
                      ...
                      <div class="btn-confirm">
                        ...
                        <form action="{{ route('extra.destroy', $p->id) }}" method="post">
                          @csrf
                          @method('DELETE')
          ...
          @else
          <div class="empty">
            <p class="desc-dark">Belum Ada Data Lain Siswa</p>
          </div>
          @endif
        </div>
      </div>
