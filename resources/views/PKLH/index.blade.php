...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/PKLH/index.css') }}">
@endsection
      ...
      <div class="main">
        <div class="button">
          ...
          <div class="modal">
            ...
            <form action="{{ route('PKLH.import') }}" method="post" enctype="multipart/form-data" class="form-modal">
              @csrf
              <input type="file" class="input-file" name="nilai_PKLH" id="nilai_PKLH">
        ...
        <div class="content">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td scope="row">
                  <a href="{{ route('PKLH.show', $p->id) }}" class="btn-edit">Lihat</a>
                  ...
                  <div class="confirm">
                    ...
                    <div class="main-confirm">
                      ...
                      <div class="btn-confirm">
                        ...
                        <form action="{{ route('PKLH.destroy', $p->id) }}" method="post">
                          @csrf
                          @method('DELETE')
          ...
          @else
          <div class="empty">
            <p class="desc-dark">Belum Ada Data Nilai PKLH Siswa</p>
          </div>
          @endif
        </div>
      </div>
