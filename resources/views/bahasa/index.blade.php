...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/bahasa/index.css') }}">
@endsection
      ...
      <div class="main">
        <div class="button">
          ...
          <div class="modal">
            ...
            <form action="{{ route('bahasa.import') }}" method="post" enctype="multipart/form-data" class="form-modal">
              @csrf
              <input type="file" class="input-file" name="nilai_bahasa" id="nilai_bahasa">
        ...
        <div class="content">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td scope="row">
                  <a href="{{ route('bahasa.show', $p->id) }}" class="btn-edit">Lihat</a>
                  ...
                  <div class="confirm">
                    ...
                    <div class="main-confirm">
                      ...
                      <div class="btn-confirm">
                        ...
                        <form action="{{ route('bahasa.destroy', $p->id) }}" method="post">
                          @csrf
                          @method('DELETE')
          ...
          @else
          <div class="empty">
            <p class="desc-dark">Belum Ada Data Nilai Bahasa Indonesia Siswa</p>
          </div>
          @endif
        </div>
      </div>
