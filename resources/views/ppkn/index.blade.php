...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/ppkn/index.css') }}">
@endsection
      ...
      <div class="main">
        <div class="button">
          ...
          <div class="modal">
            ...
            <form action="{{ route('ppkn.import') }}" method="post" enctype="multipart/form-data" class="form-modal">
              @csrf
              <input type="file" class="input-file" name="nilai_ppkn" id="nilai_ppkn">
        ...
        <div class="content">
                  ...
                  <div class="confirm">
                    ...
                    <div class="main-confirm">
                      ...
                      <div class="btn-confirm">
                        ...
                        <form action="{{ route('ppkn.destroy', $p->id) }}" method="post">
                          @csrf
                          @method('DELETE')
          ...
          @else
          <div class="empty">
            <p class="desc-dark">Belum Ada Data Nilai PPKn Siswa</p>
          </div>
          @endif
        </div>
      </div>
