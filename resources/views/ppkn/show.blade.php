...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/ppkn/show.css') }}">
@endsection
      ...
      <div class="left">
        <div class="center">
          <div class="form-group">
            ...
            <input type="text" id="nilai-pengetahuan" class="form-input" value={{$ppkn->nilai_pengetahuan}} disabled>
          </div>
          <div class="form-group">
            <label for="deskripsi_pengetahuan" class="form-label">Deskripsi:</label>
            <textarea class="form-textarea" id="deskripsi_pengetahuan" cols="27" rows="3" disabled>{{$ppkn->deskripsi_pengetahuan}}</textarea>
          </div>
        </div>
      </div>
      <div class="right">
        <div class="center">
          <div class="form-group">
            ...
            <input type="text" id="nilai-keterampilan" class="form-input" value={{$ppkn->nilai_keterampilan}} disabled>
          </div>
          <div class="form-group">
            <label for="deskripsi_keterampilan" class="form-label">Deskripsi:</label>
            <textarea class="form-textarea" id="deskripsi_keterampilan" cols="27" rows="3" disabled>{{$ppkn->deskripsi_keterampilan}}</textarea>
          </div>
        </div>
      </div>
    </div>
